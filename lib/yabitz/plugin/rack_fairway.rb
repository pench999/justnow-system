...
EOT
  ...
  module StandardRack36U
    ...
    def self.rackunit_label_pattern
      /\A[a-zA-Z]{2}[0-9]{2}-(0[1-9]|[1-2][0-9]|3[0-6])(?:[fr][12]?)?\Z/
    end
  ...
  module StandardRack47UAlphabetic
    ...
    def self.rackunit_label_pattern
      /\A[a-zA-Z]{3}[0-9]{2}-(0[1-9]|[1-3][0-9]|4[0-7])(?:[fr][12]?)?\Z/
    end
  ...
  module FukuokaRack47U
    ...
    def self.rackunit_label_pattern
      /\AQ[0-9]{2}-(0[1-9]|[1-3][0-9]|4[0-7])(?:[fr][12]?)?\Z/
    end

    def self.rackunit_label_capture_pattern
      /\A(Q[0-9]{2}-)(0[1-9]|[1-3][0-9]|4[0-7])((?:[fr][12]?)?)\Z/
    end
